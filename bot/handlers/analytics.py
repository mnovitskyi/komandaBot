...
<b>Аналітика та XP:</b>
/stat [@user] — активність за 7 днів + рівень і XP
...
+1 повідомлення · +1 за 100 символів · +3 тег/відповідь боту · +5 образа мами бота · +2 🔥 · +1 ❤️

🥚→🐣→🎮→🍺→🔫→🏕→💀→🤬→👑→🍗
(детально: /levels)

<b>Що рахується:</b> повідомлення, мати 🤬, образи мами 👩, реакції 🔥❤️, звернення до бота, активні години.
